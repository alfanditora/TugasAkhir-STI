...
Solusi yang diusulkan adalah mengembangkan sistem pencarian foto pribadi menggunakan \textit{face recognition} dengan \textit{one-shot query}. Harapannya sistem dapat digunakan untuk mengotomatisasi proses pencarian dan menghasilkan hasil yang akurat.
