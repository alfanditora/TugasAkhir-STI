...
\begin{tabular}{ | p{1cm} | p{12cm} | }
    ...
    2 & \textbf{Waktu Komputasi < 1 Detik per Tiga Identitas}:
    Sistem harus mampu melakukan deteksi, ekstraksi fitur, dan pencocokan dengan kecepatan rata-rata di bawah 1 detik per tiga identitas pada \textit{dataset} pengujian. \\ \hline
